...
/**
 * Tabs root — manages active tab state and orientation.
 */
const Tabs = ({
    className,
...
/**
 * TabsList — horizontal or vertical container for tab triggers.
 */
const TabsList = ({
    className,
    variant = "default",
...
/**
 * TabsTrigger — individual tab button within a TabsList.
 */
const TabsTrigger = ({ className, ...props }: TabsPrimitive.Tab.Props): React.JSX.Element => {
    return (
        <TabsPrimitive.Tab
...
/**
 * TabsContent — panel displayed when its associated tab is active.
 */
const TabsContent = ({ className, ...props }: TabsPrimitive.Panel.Props): React.JSX.Element => {
    return (
        <TabsPrimitive.Panel
