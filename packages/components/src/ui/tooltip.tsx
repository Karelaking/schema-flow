...
/**
 * Tooltip provider — configures shared delay and behavior for nested tooltips.
 */
...
/**
 * Tooltip root — manages open/close state.
 */
...
/**
 * Tooltip trigger — wraps the element that activates the tooltip.
 */
...
/**
 * Tooltip content — the floating popup that appears on hover/focus.
 * Handles positioning, animation, and arrow rendering.
 *
 * @param props - Popup and positioner props.
 * @returns A positioned tooltip popup element.
 */
