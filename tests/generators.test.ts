...
import { getGeneratorForDialect, createTypescriptGenerator, createSqliteGenerator } from "@/packages/generators";
import { SchemaAST } from "@/packages/schema-core";

describe("getGeneratorForDialect", () => {
    it("should return an SQLite generator for the 'sqlite' dialect", () => {
        const generator = getGeneratorForDialect("sqlite");
...
describe("SQLiteGenerator", () => {
    const sqliteGenerator = createSqliteGenerator();
...
describe("TypeScriptGenerator", () => {
    const tsGenerator = createTypescriptGenerator();
