...
export function HeroSection(): React.JSX.Element {
  return (
    <section className="relative overflow-hidden pt-12 pb-16 md:pt-20 md:pb-28">
      ...
      <div className="pointer-events-none absolute -top-40 left-1/2 -z-10 h-[500px] w-[800px] -translate-x-1/2 rounded-full bg-gradient-to-tr from-primary/20 via-sky-500/10 to-violet-500/20 blur-3xl opacity-70" />
      <div className="pointer-events-none absolute top-1/3 -right-20 -z-10 h-[350px] w-[350px] rounded-full bg-violet-600/10 blur-3xl" />
