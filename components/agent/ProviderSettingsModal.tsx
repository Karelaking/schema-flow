...
/**
 * Single model list row component.
 */
const ModelRow: React.FC<{ model: LiveModel; isSelected: boolean; onSelect: () => void }> = ({ model, isSelected, onSelect }): React.ReactElement => {
    return (
        <button
            onClick={onSelect}
...
/**
 * Props for ProviderSettingsModal component.
 */
...
/**
 * Configures AI provider selection, API key inputs, custom endpoints, and live model listing.
 */
export const ProviderSettingsModal: React.FC<ProviderSettingsModalProps> = ({ open, onOpenChange }): React.ReactElement => {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-130 max-h-[85vh] flex flex-col">
                <DialogHeader>
