...
/**
 * Message bubble item renderer for AI chat messages.
 */
const MessageBubble: React.FC<{ message: ChatMessage }> = ({ message }): React.ReactElement => {
...
/**
 * Props for AgentChatDrawer component.
 */
...
/**
 * AI Schema Architect Agent Chat drawer component.
 */
export const AgentChatDrawer: React.FC<AgentChatDrawerProps> = ({ className, style }): React.ReactElement | null => {
    ...
    const enums = useStore(s => s.enums);
    ...
    const buildSchemaAST = (): SchemaAST => ({
        project: {
            id: projectId ?? "",
            name: projectName,
            ...
            >
                <div className="flex items-center justify-between px-3 py-2.5 border-b bg-card shrink-0">
                    <div className="flex items-center gap-2">
                        <div className="size-7 rounded-lg bg-linear-to-br from-violet-500 to-indigo-600 flex items-center justify-center shadow-sm">
                ...
                <div className="flex-1 overflow-y-auto min-h-0">
                    ...
                    {messages.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-full px-4 py-8">
                            <div className="size-14 rounded-2xl bg-linear-to-br from-violet-500/20 to-indigo-600/20 flex items-center justify-center mb-4">
