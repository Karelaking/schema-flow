...
/**
 * Isolated Client Component: Renders bottom tab bar for mobile viewports.
 */
export function MobileNavigation({ activeTab, onTabChange }: MobileNavigationProps): React.JSX.Element {
  return (
