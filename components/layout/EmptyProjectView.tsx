...
/**
 * Isolated Client Component: Rendered when no database projects exist, providing initial project creation workflows.
 */
export function EmptyProjectView({ onProjectCreated }: EmptyProjectViewProps): React.JSX.Element {
